...
> Phase 0 / Python Foundation / Lesson 01
> 状态：[x] 已完成并归档
...
无。这是整个 AI Engineer Journey 的第一课。

## 服务于项目

- [Project 01 — Python AI CLI Assistant](../../projects/01-python-ai-assistant/) v0.1：单轮输入输出
